...
import 'package:investhub/app/utils/widgets/app_button/base_button.dart';
import 'package:investhub/app/utils/widgets/app_divider/app_divider.dart';

class DialogLanguageWidget extends StatelessWidget {
  const DialogLanguageWidget(
    this.content, {
    Key? key,
    this.title,
    this.titleStyle,
